...
(function (global) {
  ...
  var DICT = {
    en: {
      ...
      'nav.documents': 'Documents', 'nav.reports': 'Reports', 'nav.settings': 'Settings',
    ...
    es: {
      ...
      'nav.documents': 'Documentos', 'nav.reports': 'Informes', 'nav.settings': 'Ajustes',
    ...
    zh: {
      ...
      'nav.documents': '文档', 'nav.reports': '报告', 'nav.settings': '设置',
